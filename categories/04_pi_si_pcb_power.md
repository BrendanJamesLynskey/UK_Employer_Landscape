...
- **Sheffield**: Arm has a Manchester/Sheffield CPU verification + small HW group. **EnSilica Sheffield** is the under-rated find — mixed-signal IC design centre; analogue/digital boundary, RF/mmWave; ~40 min commute. AESSEAL, Gripple — limited board design. Sheffield Uni AMRC adjacent.
